...
import eu.toldi.bpmn_zkp.model.bpmn.MessageCatchEvent
import eu.toldi.bpmn_zkp.model.helper.TagNames
import org.w3c.dom.Node

class MessageCatchIntermediateEventParser : ElementParser {

    override fun parse(model: Model, element: Node): MessageCatchEvent {
        ...
        return MessageCatchEvent(id, transition_in, transition_out, message).also {
