...
sealed class ExclusiveGateway(name: String) : Event(name)

class ExclusiveGatewayStart(
    id: String,
    override val incomingTransition: Transition,
    override val outGoingTransitions: List<Transition>,
    val default: Transition?
) :
    ExclusiveGateway(id), SingleInput, MultiOutput

class ExclusiveGatewayEnd(
    id: String,
    override val incomingTransitions: List<Transition>,
    override val outGoingTransition: Transition
) :
    ExclusiveGateway(id), MultiInput, SingleOutput
